...
{	StackTrace("generate_series_int4");
	return generate_series_step_int4(fcinfo);
}

Datum
generate_series_step_int4(PG_FUNCTION_ARGS)
{	StackTrace("generate_series_step_int4");
